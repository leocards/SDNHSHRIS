...
class PersonnelController extends Controller
{
        ...
        try {
            ...
            $personnel = User::updateOrCreate(
                ...
                [
                    ...
                    'gradelevel' => $request->personnel['gradelevel'],
                    'curriculumnhead' => $request->personnel['curriculumnhead'],
                    'academichead' => $request->personnel['academichead'],
    ...
    {
        $jhs = User::excludeHr()->whereNull('status_updated_at')->where('department', 'junior')->orderBy('lastname')->get(['id', 'gender', 'department', 'firstname', 'lastname', 'middlename', 'extensionname', 'position']);
        $shs = User::excludeHr()->whereNull('status_updated_at')->where('department', 'senior')->orderBy('lastname')->get(['id', 'gender', 'department', 'firstname', 'lastname', 'middlename', 'extensionname', 'position']);
        $accounting = User::excludeHr()->whereNull('status_updated_at')->where('department', 'accounting')->orderBy('lastname')->get(['id', 'gender', 'department', 'firstname', 'lastname', 'middlename', 'extensionname', 'position']);
